!(function (e, t) {
  ...
  var c = {
    ...
    p = {
      ...
      cooperativeGestures: { type: Boolean, default: !1 }
    },
    l = {
  ...
  function _(e, t) {
    ...
    return function () {
      for (
        var o = [],
          a = { eventId: w(t) },
          s = P[t].events.map(function (t, r) {
            return {
              event: t,
              func: new Promise(function (n, i) {
                (o[r] = { event: t, func: S(e, t.name, a.eventId, n) }),
  ...
  var q = { drag: "drag", dragstart: "dragstart", dragend: "dragend" },
    U = { click: "click", mouseenter: "mouseenter", mouseleave: "mouseleave" },
    G = {
      name: "MapMarker",
      mixins: [c, C],
      inject: ["mapbox", "map"],
  ...
  var de = c,
    ...
    me = B,
    fe = Y,
    ye = { withEvents: c, withSelfEvents: C, asControl: B, asLayer: Y },
    ge = k,
    be = T,
    ve = F,
    Oe = Z,
      ...
      methods: {
        $_deferredMount: function () {
          if (
            ...
            var e = te({ type: "geojson" }, this.source);
            try {
        ...
        $_addLayer: function () {
          ...
          var t = te({ id: this.layerId, source: this.sourceId }, this.layer);
    ...
    we = {
      ...
      methods: {
        $_deferredMount: function () {
          var e = ne({ type: "image" }, this.source);
    ...
    Se = {
      ...
      methods: {
        $_deferredMount: function () {
          var e = ie({ type: "canvas" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
    ...
    _e = {
      ...
      methods: {
        $_deferredMount: function () {
          var e = se({ type: "video" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
    ...
    Ee = {
      ...
      methods: {
        $_deferredMount: function () {
          var e = ue({ type: "vector" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
        ...
        $_addLayer: function () {
          ...
          var t = ue({ id: this.layerId, source: this.sourceId }, this.layer);
          this.map.addLayer(t, this.before),
            this.$_emitEvent("added", { layerId: this.layerId });
        },
        setFeatureState: function (e, t) {
    ...
    Ie = {
      ...
      methods: {
        $_deferredMount: function () {
          var e = le({ type: "raster" }, this.source);
          this.map.on("dataloading", this.$_watchSourceLoading);
          try {
            this.map.addSource(this.sourceId, e);
          } catch (t) {
    ...
    xe = H;
  (e.$helpers = ye),
    (e.MglAttributionControl = je),
    (e.MglCanvasLayer = Se),
    (e.MglFullscreenControl = Oe),
    (e.MglGeojsonLayer = Pe),
    (e.MglGeolocateControl = ve),
    (e.MglImageLayer = we),
    (e.MglMap = ge),
    (e.MglMarker = Le),
    (e.MglNavigationControl = be),
    (e.MglPopup = xe),
    (e.MglRasterLayer = Ie),
    (e.MglScaleControl = $e),
    (e.MglVectorLayer = Ee),
